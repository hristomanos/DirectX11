...
struct SimpleVertex2
{
	...
	bool operator<(const SimpleVertex2 other) const
	{
		return memcmp((void*)this, (void*)&other, sizeof(SimpleVertex2)) > 0;
	};
};
...
namespace OBJLoader
{
	...
	bool FindSimilarVertex(const SimpleVertex2& vertex, std::map<SimpleVertex2, unsigned short>& vertToIndexMap, unsigned short& index);
